...
![image-20220402095727959](https://cdn.jsdelivr.net/gh/Miyuki7/image-host/blog-imgimage-20220402095727959.png)

当我们通过前面的：类的加载 –> 验证 –> 准备 –> 解析 –> 初始化，这几个阶段完成后，就会用到执行引擎对我们的类进行使用，同时执行引擎将会使用到我们运行时数据区

![image-20220402095812857](https://cdn.jsdelivr.net/gh/Miyuki7/image-host/blog-imgimage-20220402095812857.png)

类比一下也就是大厨做饭，我们把大厨后面的东西（切好的菜，刀，调料），比作是运行时数据区。而厨师可以类比于执行引擎，将通过准备的东西进行制作成精美的菜品。

![img](https://cdn.jsdelivr.net/gh/Miyuki7/image-host/blog-img0003.png)
...
![image-20220402105249849](https://cdn.jsdelivr.net/gh/Miyuki7/image-host/blog-imgimage-20220402105249849.png)

### Runtime类

**每个JVM只有一个Runtime实例**。即为运行时环境，相当于内存结构的中间的那个框框：运行时环境。

![image-20220402105323711](https://cdn.jsdelivr.net/gh/Miyuki7/image-host/blog-imgimage-20220402105323711.png)
...
![image-20220402105423392](https://cdn.jsdelivr.net/gh/Miyuki7/image-host/blog-imgimage-20220402105423392.png)
...
![image-20220402105459773](https://cdn.jsdelivr.net/gh/Miyuki7/image-host/blog-imgimage-20220402105459773.png)
...
![img](https://npm.elemecdn.com/youthlql@1.0.8/JVM/chapter_003/0009.png)
...
![image-20220402105754362](https://cdn.jsdelivr.net/gh/Miyuki7/image-host/blog-imgimage-20220402105754362.png)
...
![image-20220402105900061](https://cdn.jsdelivr.net/gh/Miyuki7/image-host/blog-imgimage-20220402105900061.png)

# 本地方法接口

## 本地方法

![img](https://npm.elemecdn.com/youthlql@1.0.8/JVM/chapter_003/0012.png)
...
![img](https://npm.elemecdn.com/youthlql@1.0.8/JVM/chapter_003/0013.png)
